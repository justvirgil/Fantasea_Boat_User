...
public class FromMessage extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference("/MessageUsers/"+Information.globalUser);
        ...
        checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    Toast.makeText(FromMessage.this, "Message Deleted", Toast.LENGTH_LONG).show();
                }
            }
            @Override
